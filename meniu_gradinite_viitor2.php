            			...
            			<div id="descarca_butoane">
                        		<div id="butoane_sapt">
                                       ...
                                       <div id="saptamana_viitoare">
                                        		<a href="meniu_gradinite2.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('saptamana_viitoare_pic','','images/meniu/sapt_viitoare.png',1)">
                        ...
                        <div id="content_jos"><!--  ------------START OF CONTENT JOS------------ -->
                                    ...
                                    <div id="meniu_copii_poza"><!-- start of meniu_copii_poza -->
                                            ...
                                            <?php
														if (date('W', time()+3600*8)==51)  
															{
																$meniu_luat="meniu_gradinite_viitor3"; 
																
															}
														else if (date('W', time()+3600*8)==52)  
															{
																$meniu_luat="meniu_gradinite_viitor2"; //IO
																
															} 
														
														else  $meniu_luat="meniu_gradinite_viitor";
