...
if ((date('W', time()+3600*8)==52)|| (date('W', time()+3600*8)==1))
 {
 header('Location: http://www.quick-lunch.ro/meniu_copii_viitor2.php');
 exit;
 }
include "db.php";
?>
                        		...
                        		<div id="butoane_sapt">
                                        <div id="saptamana_curenta">
										 ...
										 <div id="saptamana_viitoare">
                                        		<a href="meniu_copii_viitor2.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('saptamana_viitoare_pic','','images/meniu/sapt_viitoare.png',1)">
