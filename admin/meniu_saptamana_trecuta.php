	...
	<tr height="25">
    	...
    	<td width="833" bgcolor="#ffffff" align="left" valign="middle" >
             ...
             <b>Meniu pe saptamana curenta</b> 
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;</span>
           	<a class="verde_mic" href="meniu.php">[meniu pe saptamana curenta]</a>&nbsp;&nbsp;&nbsp;	<a class="verde_mic" href="meniu_saptamana_viitoare.php">[meniu pe saptamana viitoare]</a>
        </td>
    	<td width="23" bgcolor="#91c102">
        </td>            
    </tr>
	...
	<tr >
    	...
    	<td width="833" bgcolor="#ffffff" align="center" >
            <table width="810" cellspacing="1" cellpadding="0" bgcolor="#928D79" align="center">
                <tr >
                <form name="meniu_trecut_form" action="comanda_trecuta.php" method="post" >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','a',$next_day, $ss);
                            echo $s;
                        ?> 
                </tr>
                <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','b',$next_day, $ss);
                            echo $s;
                        ?> 
                </tr>
                <tr >
                    <td width="50" bgcolor="#fffddf" align="center" rowspan="9">
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','c',$next_day, $ss);
                            echo $s;
                        ?> 
                </tr>
                <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','da',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>    
                 <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','db',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>    
                <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','e',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>
                 <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','r',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>
                <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','f',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','f',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','f',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','f',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','f',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>
                <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','g',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>
                <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','s',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>
                <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','h',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>
                <tr >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','i',$next_day, $ss);
                            echo $s;
                        ?>                            
                </tr>     
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','j',$next_day, $ss);
                            echo $s;
                        ?>                            
                </tr>  
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','k',$next_day, $ss);
                            echo $s;
                        ?>                            
                </tr>
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','l',$next_day, $ss);
                            echo $s;
                        ?>                            
                </tr>
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','m',$next_day, $ss);
                            echo $s;
                        ?>                            
                </tr> 
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_trecut",'luni','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'marti','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'miercuri','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'joi','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_trecut",'vineri','n',$next_day, $ss);
                            echo $s;
                        ?>                            
                </tr> 
  			</table>
                ...
                <tr height="261" id="error">
                	<td width="495" bgcolor="#fffddf" valign="top">
                    	<table width="495" bgcolor="#fffddf" cellspacing="0" cellpadding="0" border="0">
                          ...
                          <tr height="26" valign="middle">
                            	<td width="50" align="right">
                                	<span class="gri_mic">Nr. ORC</span>                                </td>
                                <td width="135" align="center" valign="middle">
                                	<input type="text" name="nr_orc" class="date_textbox" />
                                </td>
                                <td width="120">
                                </td>
                                <td width="180" align="center">&nbsp;</td>  
                          ...
                          <tr height="26" valign="middle">
                            	<td width="50" align="right">
                                	<span class="gri_mic">CF</span>                                </td>
                                <td width="135" align="center" valign="middle">
                                	<input type="text" name="cod_fiscal" class="date_textbox" />
                                </td>
                                <td width="120">
                                </td>
                                <td width="180" align="center">&nbsp;</td>  
                          ...
                          <tr height="26" valign="middle">
                            	<td width="50" align="right">
                                	<span class="gri_mic">Judetul</span>
                                </td>
                                <td width="135" align="center" valign="middle">
                                	<input type="text" name="judet"  class="date_textbox" />
                                </td>
                                <td width="120">
                                </td>
                                <td width="180" align="center">&nbsp;</td>  
                          ...
                          <tr height="26" valign="middle">
                            	<td width="50" align="right">
                                	<span class="gri_mic">Cont</span>
                                </td>
                                <td width="135" align="center" valign="middle">
                                	<input type="text" name="cont"  class="date_textbox" />
                                </td>
                                <td width="120">
                                </td>
                                <td width="180" align="center">&nbsp;</td>  
                          ...
                          <tr height="26" valign="middle">
                            	<td width="50" align="right">
                                	<span class="gri_mic">Banca</span>                                </td>
                                <td width="135" align="center" valign="middle">
                                	<input type="text" name="banca"  class="date_textbox" />
                                </td>
                                <td width="120">
                                </td>
                                <td width="180" align="center">&nbsp;</td>  
