<?php
	...
	$zi=$_POST['zi'];
	$tip=$_POST['tip'];
	$query="select * from meniu_curent where ziua=\"$zi\" and tip=\"$tip\"";
...
<br />
	<table align="center" width="800" bgcolor="#FFFFFF">
    	<form action="edit_meniu_curent.php" method="post" enctype="multipart/form-data">
    	<tr>
	...
	?>
    	...
    	<tr>
            ...
            <td class="text2" align="center" width="20%">	
                ...
                Click pentru a sterge poza: <a href="del_poza_meniu_curent.php?zi=<?php echo $zi; ?>&tip=<?php echo $tip; ?>"><img class="poza" src="imgs/del.jpg" height="10" /></a>
            </td>
        </tr>
