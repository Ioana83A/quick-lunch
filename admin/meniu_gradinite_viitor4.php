<?php
	...
	$zi=$_POST['zi'];
	$tip=$_POST['tip'];
	$query="select * from meniu_gradinite_viitor4 where ziua=\"$zi\" and tip=\"$tip\"";
...
<br />
	<table align="center" width="800" bgcolor="#FFFFFF">
    	<form action="edit_meniu_gradinite_viitor4.php" method="post" enctype="multipart/form-data">
    	<tr>
