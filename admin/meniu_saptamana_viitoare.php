	...
	<tr height="25">
    	...
    	<td width="833" bgcolor="#ffffff" align="left" valign="middle" >
             ...
             <b>Meniu pe saptamana viitoare</b> 
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;</span>
           	<a class="verde_mic" href="meniu_saptamana_trecuta.php">[meniu pe saptamana trecuta]</a>&nbsp;&nbsp;&nbsp;	<a class="verde_mic" href="meniu.php">[meniu pe saptamana curenta]</a>
        </td>
    	<td width="23" bgcolor="#91c102">
        </td>            
    </tr>     
	...
	<tr >
    	...
    	<td width="833" bgcolor="#ffffff" align="center" >
            <table width="810" cellspacing="1" cellpadding="0" bgcolor="#928D79" align="center">
                ...
                <tr >
                    <td width="50" bgcolor="#fffddf" align="center" rowspan="7">
                ...
                <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor",'luni','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'marti','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'miercuri','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'joi','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'vineri','da',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>   
                 <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor",'luni','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'marti','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'miercuri','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'joi','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'vineri','db',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>     
                <tr >			           
                ...
                <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        <font class="gri_mare_meniu">G</font><br />
