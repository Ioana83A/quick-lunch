...
<table width="878" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr height="25">
    	...
    	<td width="833" bgcolor="#ffffff" align="left" valign="middle" >
             ...
             <b>Meniul de peste trei saptamani(doar vizualizare- nefunctional)</b> 
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;</span>
            ...
            <table width="810" cellspacing="1" cellpadding="0" bgcolor="#928D79" align="center">
                <tr >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','a',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','aa',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','v',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','ab',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','b',$next_day, $ss);
                           echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','b',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                       ...
                       <span class="gri_mic_meniu">tocanite<br />manca-<br />ruri</span>
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','c',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','da',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <tr >
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','db',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                ...
                <tr >
                   <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','e',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor3",'marti','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','e',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                   <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','ag',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor3",'marti','ag',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','ag',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','ag',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','ag',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               ...
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','f',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','f',$next_day, $ss);
                           echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','f',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','f',$next_day, $ss);
                           echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','f',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor3",'luni','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','g',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor3",'luni','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','ac',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor3",'luni','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','s',$next_day, $ss);
                            echo $s;
                        ?>
               </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor3",'luni','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','ad',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor3",'luni','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','t',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor3",'luni','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','ae',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor3",'luni','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','y',$next_day, $ss);
                            echo $s;
                        ?>
               </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor3",'luni','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','af',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','h',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','i',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr>
                 <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','x',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr>
					...
					<!--<span class="puncte_weekend">1 punct</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','j',$next_day, $ss);
                            echo $s;
                          $s = meniu_zi("meniu_viitor3",'vineri','j',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                 ...
                 <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','z',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
				   <tr>
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','k',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr>
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','o',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','o',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','o',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor3",'joi','o',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor3",'vineri','o',$next_day, $ss);
                           echo $s;
                        ?>
               </tr>
                <tr>
                   <td width="50" bgcolor="#fffddf" align="center" >
		            ...
		            <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','p',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                ...
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','l',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <!-- Oferta bucatarului -->
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','u',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor3",'miercuri','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','u',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','r',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor3",'miercuri','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','r',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','q',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor3",'miercuri','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','q',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
                <tr>
                   ...
                   <td width="50" bgcolor="#fffddf" align="center">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor3",'luni','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','m',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor3",'luni','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'marti','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'miercuri','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'joi','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor3",'vineri','n',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
  			</table>
