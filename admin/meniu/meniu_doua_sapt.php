...
<table width="878" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr height="25">
    	...
    	<td width="833" bgcolor="#ffffff" align="left" valign="middle" >
             ...
             <b>Meniul de peste doua saptamani(doar vizualizare- nefunctional)</b> 
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;</span>
            ...
            <table width="810" cellspacing="1" cellpadding="0" bgcolor="#928D79" align="center">
                <tr >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','a',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','aa',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','v',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','ab',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','b',$next_day, $ss);
                           echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','b',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                       ...
                       <span class="gri_mic_meniu">tocanite<br />manca-<br />ruri</span>
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','c',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','da',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','db',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                ...
                <tr >
                   <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','e',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor2",'marti','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','e',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <tr >
                   <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','ag',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor2",'marti','ag',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','ag',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','ag',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','ag',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','f',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','f',$next_day, $ss);
                           echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','f',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','f',$next_day, $ss);
                           echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','f',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor2",'luni','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','g',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor2",'luni','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','ac',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor2",'luni','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','s',$next_day, $ss);
                            echo $s;
                        ?>
               </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor2",'luni','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','ad',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor2",'luni','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','t',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor2",'luni','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','ae',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor2",'luni','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','y',$next_day, $ss);
                            echo $s;
                        ?>
               </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor2",'luni','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','af',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','h',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                ...
                <tr >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','i',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr>
                 <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','x',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr>
					...
					<!--<span class="puncte_weekend">1 punct</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','j',$next_day, $ss);
                            echo $s;
                          $s = meniu_zi("meniu_viitor2",'vineri','j',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                <td width="50" bgcolor="#fffddf" align="center">
                 ...
                 <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','z',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
				   <tr>
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','k',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr>
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','o',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','o',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','o',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor2",'joi','o',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor2",'vineri','o',$next_day, $ss);
                           echo $s;
                        ?>
               </tr>
                <tr>
                   <td width="50" bgcolor="#fffddf" align="center" >
		            ...
		            <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','p',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                ...
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','l',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <!-- Oferta bucatarului -->
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','u',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor2",'miercuri','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','u',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','r',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor2",'miercuri','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','r',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','q',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor2",'miercuri','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','q',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
                <tr>
                   ...
                   <td width="50" bgcolor="#fffddf" align="center">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor2",'luni','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','m',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor2",'luni','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'marti','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'miercuri','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'joi','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor2",'vineri','n',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
  			</table>
