...
<table width="878" border="0" cellpadding="0" cellspacing="0" align="center">
	...
	<tr height="25">
    	...
    	<td width="833" bgcolor="#ffffff" align="left" valign="middle" >
             ...
             <b>Meniul de peste cinci saptamani(doar vizualizare- nefunctional)</b> 
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;</span>
            	...
            	<tr height="25" valign="middle">
                     ...
                     <span class="alb_sapt">
                    	<?php
							...
							$acum = time();
							$time_azi = strtotime("+8 hours",$now);
							$time_next = strtotime("+5 week",$time_azi);
            ...
            <table width="810" cellspacing="1" cellpadding="0" bgcolor="#928D79" align="center">
                <tr >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','a',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','a',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','aa',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','aa',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','v',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','ab',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','ab',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','b',$next_day, $ss);
                           echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','b',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','b',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                       ...
                       <span class="gri_mic_meniu">tocanite<br />manca-<br />ruri</span>
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','c',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','c',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','da',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <tr >
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','db',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                ...
                <tr >
                   <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','e',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor5",'marti','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','e',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','e',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <tr >
                   <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','ag',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor5",'marti','ag',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','ag',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','ag',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','ag',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','f',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','f',$next_day, $ss);
                           echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','f',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','f',$next_day, $ss);
                           echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','f',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor5",'luni','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','g',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','g',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor5",'luni','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','ac',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','ac',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor5",'luni','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','s',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','s',$next_day, $ss);
                            echo $s;
                        ?>
               </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor5",'luni','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','ad',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','ad',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor5",'luni','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','t',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','t',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor5",'luni','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','ae',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','ae',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor5",'luni','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','y',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','y',$next_day, $ss);
                            echo $s;
                        ?>
               </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor5",'luni','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','af',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','af',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','h',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','h',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr >
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','i',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','i',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr>
                 <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','x',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
               <tr>
					...
					<!--<span class="puncte_weekend">1 punct</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','j',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','j',$next_day, $ss);
                            echo $s;
                          $s = meniu_zi("meniu_viitor5",'vineri','j',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                 ...
                 <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','z',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','z',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
				   <tr>
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','k',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','k',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr>
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','o',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','o',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','o',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor5",'joi','o',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor5",'vineri','o',$next_day, $ss);
                           echo $s;
                        ?>
               </tr>
                <tr>
                   <td width="50" bgcolor="#fffddf" align="center" >
		            ...
		            <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','p',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                ...
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','l',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','l',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                 <!-- Oferta bucatarului -->
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','u',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor5",'miercuri','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','u',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','r',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor5",'miercuri','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','r',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','r',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','q',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor5",'miercuri','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','q',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
                <tr>
                   ...
                   <td width="50" bgcolor="#fffddf" align="center">
                       ...
                       <?php
                            $s = meniu_zi("meniu_viitor5",'luni','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','m',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','m',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr>
                    ...
                    <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor5",'luni','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'marti','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'miercuri','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'joi','n',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor5",'vineri','n',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
  			</table>
