	...
	<tr height="25">
    	...
    	<td width="833" bgcolor="#ffffff" align="left" valign="middle" >
             ...
             <b>Meniu pe saptamana curenta</b> 
              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;</span>
           	<a class="verde_mic" href="meniu_saptamana_trecuta.php">[meniu pe saptamana trecuta]</a>&nbsp;&nbsp;&nbsp;	<a class="verde_mic" href="meniu_saptamana_viitoare.php">[meniu pe saptamana viitoare]</a>
        </td>
    	<td width="23" bgcolor="#91c102">
        </td>            
    </tr>
        	...
        	<table width="810" bgcolor="#8BB903">
            	<tr height="25" valign="middle">
                     ...
                     <span class="alb_sapt">
                    	<?php
							$acum = time();
							$time_azi = strtotime("+9 hours",$acum);
	...
	<tr >
    	...
    	<td width="833" bgcolor="#ffffff" align="center" >
            <table width="810" cellspacing="1" cellpadding="0" bgcolor="#928D79" align="center">
                <tr >
                <form name="meniu_curent_form" action="comanda.php" method="post" >
                ...
                <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_curent",'luni','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_curent",'marti','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_curent",'miercuri','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_curent",'joi','da',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_curent",'vineri','da',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr> 
                 <tr >			           
                    <td width="50" align="center" bgcolor="#fffddf">
                        ...
                        <?php
                            $s = meniu_zi("meniu_curent",'luni','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_curent",'marti','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_curent",'miercuri','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_curent",'joi','db',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_curent",'vineri','db',$next_day, $ss);
                            echo $s;
                        ?>            
                </tr>       
                <tr >			           
