<?php
	...
	$zi=$_POST['zi'];
	$tip=$_POST['tip'];
	$query="select * from meniu_gradinite_viitor2 where ziua=\"$zi\" and tip=\"$tip\"";
...
<br />
	<table align="center" width="800" bgcolor="#FFFFFF">
    	<form action="edit_meniu_gradinite_viitor2.php" method="post" enctype="multipart/form-data">
    	<tr>
        	<td colspan="5" align="center" class="text1">
            	Editati meniul de peste doua saptamani ziua <?php echo $zi; ?>
            </td>
        </tr>
    <?php
