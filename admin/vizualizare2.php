                	...
                	<td width="638" colspan="8">
                    	<table width="638" border="0" cellpadding="0" cellspacing="0" align="center">
                        	<tr height="8">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1">	
								<?php
									$s=0;
                                ...
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1">
								<?php
									$s=afisare('marti','A',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                ...
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('vineri','A',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            </tr>
                            <tr height="2">
                            ...
                            <tr height="8">
								...
								<?php
									$s=0;
									$s=afisare('luni','AA',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1">
								<?php
									$s=afisare('marti','AA',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('miercuri','AA',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('joi','AA',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('vineri','AA',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
								...
								<?php
									$s=0;
									$s=afisare('luni','AB',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1">
								<?php
									$s=afisare('marti','AB',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('miercuri','AB',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('joi','AB',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('vineri','AB',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php	
                                	$s=afisare('luni','B',$id,$s);
								?></span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php	
                            ...
                            <tr height="8">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('luni','DA',$id,$s);
								?></span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('marti','DA',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('miercuri','DA',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('joi','DA',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('vineri','DA',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('luni','DB',$id,$s);
								?></span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('marti','DB',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('miercuri','DB',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('joi','DB',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('vineri','DB',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('luni','AG',$id,$s);
								?></span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('marti','AG',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('miercuri','AG',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('joi','AG',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('vineri','AG',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
								...
								<?php
									$s=0;
									$s=afisare('luni','AC',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1">
								<?php
									$s=afisare('marti','AC',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('miercuri','AC',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('joi','AC',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('vineri','AC',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
								...
								<?php
									$s=0;
									$s=afisare('luni','AD',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1">
								<?php
									$s=afisare('marti','AD',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('miercuri','AD',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('joi','AD',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('vineri','AD',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
    						   <td width="40" bgcolor="#fffcd6" align="center" valign="middle"><span class="gri1">G3</span>
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('luni','T',$id,$s);
								?></span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('marti','T',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('miercuri','T',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('joi','T',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('vineri','T',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
								...
								<?php
									$s=0;
									$s=afisare('luni','AE',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1">
								<?php
									$s=afisare('marti','AE',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('miercuri','AE',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('joi','AE',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('vineri','AE',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
    						   <td width="40" bgcolor="#fffcd6" align="center" valign="middle"><span class="gri1">G4</span>
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('luni','Y',$id,$s);
								?></span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('marti','Y',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('miercuri','Y',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('joi','Y',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
                                	$s=afisare('vineri','Y',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
								...
								<?php
									$s=0;
									$s=afisare('luni','AF',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1">
								<?php
									$s=afisare('marti','AF',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('miercuri','AF',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('joi','AF',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"><?php
									$s=afisare('vineri','AF',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                            ...
                            <tr height="8">
                                ...
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"> 
								<?php
                            ...
                            <tr height="8">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1">
                                <?php
                                	$s=afisare('luni','Z',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1">
                                 <?php
                                	$s=afisare('marti','Z',$id,$s);
								?>
                                </span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"> <?php
                                	$s=afisare('miercuri','Z',$id,$s);
								?></span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"> <?php
                                	$s=afisare('joi','Z',$id,$s);
								?></span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"> 
								<?php
                                	$s=afisare('vineri','Z',$id,$s);
								?></span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru1"></span>
                                </td>
                	...
                	<td width="638" colspan="8">
                    	<table width="638" border="0" bgcolor="#FFFFFF" cellpadding="0" cellspacing="4" align="center">
                            ...
                            <tr height="10">
                                ...
                                <td width="109" bgcolor="#ffffff" align="left" valign="middle"><span class="negru1"><b><?php total($id,$day,$month,$year); ?></b></span><span class="negru_mic"> RON</span> 
                                </td>
                             </tr>
                             <tr height="10">
