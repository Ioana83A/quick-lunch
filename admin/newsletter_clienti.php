                	...
                	<td width="638" colspan="8">
                    	<table width="638" border="0" cellpadding="0" cellspacing="0" align="center">
							...
							<tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','AA',$id,$s).'
                                </span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('marti','AA',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('miercuri','AA',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('joi','AA',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('vineri','AA',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
							...
							<tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','AB',$id,$s).'
                                </span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('marti','AB',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('miercuri','AB',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('joi','AB',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('vineri','AB',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                            ...
                            <tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','DA',$id,$s).'</span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('marti','DA',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('miercuri','DA',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('joi','DA',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('vineri','DA',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                            ...
                            <tr height="5">
							  ...
							  <tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','DB',$id,$s).'</span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('marti','DB',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('miercuri','DB',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('joi','DB',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('vineri','DB',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                            ...
                            <tr height="5">
							 ...
							 <tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','AG',$id,$s).'</span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('marti','AG',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('miercuri','AG',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('joi','AG',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('vineri','AG',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                            ...
                            <tr height="5">
                             ...
                             <tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','AC',$id,$s).'</span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('marti','AC',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('miercuri','AC',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('joi','AC',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('vineri','AC',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                            ...
                            <tr height="5">
							 ...
							 <tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','AD',$id,$s).'</span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('marti','AD',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('miercuri','AD',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('joi','AD',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('vineri','AD',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
							...
							<tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','T',$id,$s).'</span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('marti','T',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('miercuri','T',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('joi','T',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('vineri','T',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                            ...
                            <tr height="5">
							 ...
							 <tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','AE',$id,$s).'</span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('marti','AE',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('miercuri','AE',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('joi','AE',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('vineri','AE',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                            ...
                            <tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','Y',$id,$s).'</span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('marti','Y',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('miercuri','Y',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('joi','Y',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('vineri','Y',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                            ...
                            <tr height="5">
							 ...
							 <tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.afisare2('luni','AF',$id,$s).'</span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('marti','AF',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('miercuri','AF',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('joi','AF',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">'.
                                	afisare2('vineri','AF',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
							...
							<tr height="20">
                                ...
                                <td width="80" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru">
                                '.
                                	afisare2('luni','Z',$id,$s).'
                                </span>
                                </td>
                                <td width="85" bgcolor="#fffcd6" align="center" valign="middle">
									<span class="negru">'.afisare2('marti','Z',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"> '.
                                	afisare2('miercuri','Z',$id,$s).'</span>
                                </td>
                                <td width="84" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"> '.
                                	afisare2('joi','Z',$id,$s).'</span>
                                </td>
                                <td width="83" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"> 
								'.
                                	afisare2('vineri','Z',$id,$s).'</span>
                                </td>
                                <td width="74" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                                </td>
                                <td width="108" bgcolor="#fffcd6" align="center" valign="middle"><span class="negru"></span>
                	...
                	<td width="638" colspan="8">
                    	<table width="638" border="0" bgcolor="#FFFFFF" cellpadding="0" cellspacing="4" align="center">
                            ...
                            <tr height="20">
                                ...
                                <td width="109" bgcolor="#ffffff" align="left" valign="middle"><span class="negru"><b>'.total2($id,$day,$month,$year).'</b></span><span class="negru_mic"> RON</span> 
                                </td>
                             </tr>
                             <tr height="1">
                                <td  colspan="5" bgcolor="#ffffff" align="right" valign="middle">
