          ...
          <div id="sus_centru">            </div>
            ...
            <!-- ================================== CONTENT =============================== -->
            			<div id="descarca_butoane">
                        		<div id="butoane_sapt">
									   ...
									   ?>
                                        <div id="saptamana_viitoare">
                                        		<a href="meniu_copii2.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('saptamana_viitoare_pic','','images/meniu/sapt_viitoare.png',1)">
                                ...
                                <div id="deacarca_content">
                                        ...
                                        <div id="descarca_content_jos">
                                        		<form action="descarca_pdf_copii.php" method="post" name="descarca_meniu_form" target="_blank" >
                        ...
                        <div id="content_jos"><!--  ------------START OF CONTENT JOS------------ -->
                                	<div id="feluri"><img src="images/meniu_copii/feluri_scoli.jpg" /></div>
                                    <div id="meniu_copii_poza"><!-- start of meniu_copii_poza -->
                                            ...
                                            <?php
														if (date('W', time()+3600*8)==51)  
															{
																$meniu_luat="meniu_copii_viitor3"; 
																
															}
														else if (date('W', time()+3600*8)==52)    //IO
															{
																$meniu_luat="meniu_copii_viitor2"; 
																
															} 
														else  $meniu_luat="meniu_copii_viitor";
                                    ...
                                    <div id="feluri_pret_comanda"><!-- start of feluri_pret_comanda -->
                                        ...
                                        <div id="comanda_feluri"><!-- start of comanda_feluri -->
                                        		Tu comanzi iar noi livr&#259;m la &#351;coala<br />
                                                copilului t&#259;u!<br /> 
