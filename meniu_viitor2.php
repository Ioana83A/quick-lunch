...
function validate_meniu(myform)
{
	...
	if (myform.bucD1l.value !='' && myform.bucD1l.value != null)
	{
		return true;
	}
	if (myform.bucD1m.value !='' && myform.bucD1m.value != null)
	{
		return true;
	}
	if (myform.bucD1mi.value !='' && myform.bucD1mi.value != null)
	{
		return true;
	}
	if (myform.bucD1j.value !='' && myform.bucD1j.value != null)
	{
		return true;
	}
	if (myform.bucD1v.value !='' && myform.bucD1v.value != null)
	{
		return true;
	}
	if (myform.bucD2l.value !='' && myform.bucD2l.value != null)
	{
		return true;
	}
	if (myform.bucD2m.value !='' && myform.bucD2m.value != null)
	{
		return true;
	}
	if (myform.bucD2mi.value !='' && myform.bucD2mi.value != null)
	{
		return true;
	}
	if (myform.bucD2j.value !='' && myform.bucD2j.value != null)
	{
		return true;
	}
	if (myform.bucD2v.value !='' && myform.bucD2v.value != null)
	{
		return true;
	}
...
<?php
	...
	if (strcmp($ss,0) == 0)
	{
		$alert = 'Astazi este '.$day[$azi].' ora '.$ora2_h.':'.$ora2_m.':'.$ora2_s.'. Se poate comanda pentru '.$zile.' din saptamana curenta si pentru saptamana viitoare.';
                        		...
                        		<div id="butoane_sapt">                                 
									   <div id="saptamana_curenta">
                                                ...
                                                <div id="numar"> <span id="alb_saptamana">
														...
														else if (date('W', time()+3600*8)==52)  //IO
																{
																	$now = time();
																	$time_azi = strtotime("+8 hours",$now);
                                       ...
                                       <div id="saptamana_viitoare">   
                                        		<a href="meniu_curent2.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('saptamana_viitoare_pic','','images/meniu/sapt_viitoare.png',1)">
            	...
            	<tr height="25" valign="middle">
                     ...
                     <span class="alb_sapt1">
                    	<?php
							...
							{
								$time_azi = strtotime("+8 hours",$acum);
								$time_azi = strtotime("+2 week",$time_azi);
    	...
    	<td width="833" bgcolor="#ffffff" align="center" >
            <table width="810" cellspacing="1" cellpadding="0" bgcolor="#928D79" align="center">
                ...
                <form name="meniu_viitor_form" action="comanda_viitor.php" method="post" onsubmit="return validate(this);">
					...
					if (date('W', time()+3600*8)==51)  
						{
							$meniu_luat="meniu_viitor3"; 
							
						}
					else if (date('W', time()+3600*8)==52)  //IO
						{
							$meniu_luat="meniu_viitor2"; 
							
						}  	 
					else  $meniu_luat="meniu_viitor";
