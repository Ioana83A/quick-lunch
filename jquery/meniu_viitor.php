            ...
            <!-- ================================== CONTENT =============================== -->
						...
						?>
                                        ...
                                        <div id="saptamana_viitoare">
                                        		<a href="meniu_curent.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('saptamana_viitoare_pic','','images/meniu/sapt_viitoare.png',1)">
            	...
            	<tr height="25" valign="middle">
                     ...
                     <span class="alb_sapt1">
						...
						//$time_azi = strtotime("+8 hours",$acum);
							$time_azi = strtotime("+176 hours",$acum);
    	...
    	<td width="833" bgcolor="#ffffff" align="center" >
            <table width="810" cellspacing="1" cellpadding="0" bgcolor="#928D79" align="center">
                ...
                <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor",'luni','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'marti','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'miercuri','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'joi','v',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'vineri','v',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
               <tr >
                ...
                <tr >
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor",'luni','w',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'marti','w',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'miercuri','w',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'joi','w',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'vineri','w',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <tr >
               ...
               <tr >
                ...
                <tr>
                 <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor",'luni','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'marti','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'miercuri','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'joi','x',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'vineri','x',$next_day, $ss);
                            echo $s;
                       ?>
                </tr>
                <tr>
                ...
                <tr>
					...
					<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor",'luni','o',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'marti','o',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'miercuri','o',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor",'joi','o',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor",'vineri','o',$next_day, $ss);
                           echo $s;
                        ?>
               </tr>
                <tr>
                   <td width="50" bgcolor="#fffddf" align="center" >
		            ...
		            <td width="50" bgcolor="#fffddf" align="center">
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor",'luni','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'marti','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'miercuri','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'joi','p',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'vineri','p',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor",'luni','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'marti','u',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor",'miercuri','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'joi','u',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'vineri','u',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
				...
				<!--<span class="puncte_weekend">3 puncte</span>-->
                        ...
                        <?php
                            $s = meniu_zi("meniu_viitor",'luni','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'marti','q',$next_day, $ss);
                            echo $s;
                           $s = meniu_zi("meniu_viitor",'miercuri','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'joi','q',$next_day, $ss);
                            echo $s;
                            $s = meniu_zi("meniu_viitor",'vineri','q',$next_day, $ss);
                            echo $s;
                        ?>
                </tr>
                <!-- ________________ -->
